"""
Django settings for receipe_management project.
...
SECRET_KEY = 'django-insecure-&eqlv^ne!6x@9+&iji!il14n#8r)8)$pj^g-4@yil(k&p36t_*'
...
ROOT_URLCONF = 'receipe_management.urls'
...
WSGI_APPLICATION = 'receipe_management.wsgi.application'
